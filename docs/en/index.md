...
This is the **second guide in a trilogy**: it comes after the [fundamentals guide](https://jmlopezdona.github.io/ai-coding-agents-fundamentals/) (what an agent is, how to use one) and before the [harness engineering guide](https://jmlopezdona.github.io/ai-coding-agents-harness/) (how to engineer the system around the agent). SDD is the discipline in between: **how to structure work so the agent can execute it well**.
