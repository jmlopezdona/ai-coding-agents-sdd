...
- **Fundamentals** te enseñó qué es un agente, cómo se le habla, qué herramientas tiene. Es el "qué".
- **SDD** (este curso) te enseña a estructurar el trabajo para que el agente pueda ejecutarlo bien. Es el "cómo trabajar con él".
- **Harness Engineering** te enseña a ingeniar el sistema alrededor del agente — sandboxes, sensores, hooks, observabilidad, el repo entero como sustrato. Es el "qué se construye alrededor".
