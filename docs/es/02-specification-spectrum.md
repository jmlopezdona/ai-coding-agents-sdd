...
Una de las cosas más útiles que aporta el paper de arXiv sobre Spec-Driven Development es que se niega a presentar el SDD como una cosa única. Lo presenta como un **espectro de tres niveles de compromiso**, y entender en cuál de los tres operas — y en cuál crees que operas — es probablemente la decisión más consecuente que vas a tomar en este curso.
