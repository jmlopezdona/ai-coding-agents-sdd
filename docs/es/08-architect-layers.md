...
Cuando un equipo ya usa Cursor, Claude Code, Codex o similar y los conoce bien, la fricción de adoptar Kiro o Spec-kit no es solo aprender una herramienta nueva. Es **abandonar la herramienta donde el equipo tiene horas, atajos, configuraciones y memoria muscular**. Y para muchos equipos, ese coste es prohibitivo aunque la nueva herramienta sea objetivamente mejor en algunas dimensiones.
