...
Si reconoces dos o más, es momento de empezar a construir infraestructura. La [guía de harness engineering](https://jmlopezdona.github.io/ai-coding-agents-harness/es/) desarrolla los mecanismos concretos para dar ese paso.
