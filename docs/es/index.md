...
Es la **segunda guía de una trilogía**: viene después de los [fundamentos](https://github.com/jmlopezdona/ai-coding-agents-fundamentals) (qué es un agente, cómo se usa) y antes del [harness](https://github.com/jmlopezdona/ai-coding-agents-harness) (cómo se ingenía el sistema alrededor del agente). El SDD es la disciplina intermedia: **cómo estructurar el trabajo para que el agente pueda ejecutarlo bien**.
